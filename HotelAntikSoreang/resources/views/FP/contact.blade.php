        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div data-aos="fade-right" data-aos-duration="1000">
                    ...
                    @if (session('success'))
                        <div class="mb-8 p-6 bg-green-50 border border-green-200 rounded-2xl text-green-800 text-center font-medium shadow-lg" role="alert">
                            {{ session('success') }}
                            <svg class="w-6 h-6 mx-auto mt-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                            </svg>
                        </div>
                    @endif
                    
                    <form class="form-container p-10" method="POST" action="{{ route('contact.store') }}">
                        @csrf
...
<div class="form-group">
                ...
                <div data-aos="fade-left" data-aos-duration="1000" class="space-y-8">
                    ...
                    <div class="mt-16 pt-16 border-t border-gray-100">
                        ...
                        <h3 class="text-3xl font-display font-bold mb-12 text-gray-900 text-center">
                            Apa Kata Tamu Kami
                        </h3>
                        <div class="grid md:grid-cols-2 gap-8">
                            <div class="bg-gradient-to-br from-indigo-50 to-purple-50 p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 border border-white/50">
                                <div class="flex items-center gap-4 mb-6">
                                    <div class="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center text-white font-bold text-xl">RS</div>
                                    <div>
                                        <p class="font-bold text-gray-900">Rina S.</p>
                                        <p class="text-sm text-gray-500">Family Stay</p>
                                    </div>
                                </div>
                                <p class="text-lg text-gray-700 italic mb-6 leading-relaxed">"Pelayanan ramah dan kamar sangat nyaman. Lokasi strategis dan makanan lezat!"</p>
                                <div class="flex gap-1 text-2xl text-yellow-400">⭐⭐⭐⭐⭐</div>
                            </div>
                            <div class="bg-gradient-to-br from-indigo-50 to-purple-50 p-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 border border-white/50">
                                <div class="flex items-center gap-4 mb-6">
                                    <div class="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center text-white font-bold text-xl">AB</div>
                                    <div>
                                        <p class="font-bold text-gray-900">Andi B.</p>
                                        <p class="text-sm text-gray-500">Business Trip</p>
                                    </div>
                                </div>
                                <p class="text-lg text-gray-700 italic mb-6 leading-relaxed">"Fasilitas lengkap dan tim sangat responsif. Sangat direkomendasikan untuk perjalanan bisnis."</p>
                                <div class="flex gap-1 text-2xl text-yellow-400">⭐⭐⭐⭐⭐</div>
                            </div>
                        </div>
                    </div>
    ...
    <a href="https://wa.me/6281234567890?text=Halo%20Hotel%20Antik%2C%20saya%20ingin%20bertanya%20tentang..." 
       class="fixed bottom-8 right-8 z-50 w-16 h-16 bg-green-500 hover:bg-green-600 shadow-2xl rounded-full flex items-center justify-center text-white text-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1" 
       target="_blank" rel="noopener">
        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.89..." />
        </svg>
    </a>
